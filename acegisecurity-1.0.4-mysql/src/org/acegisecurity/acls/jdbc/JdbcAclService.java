 ...
 *
 * @author Ben Alex
 * @version $Id: JdbcAclService.java,v 1.2 2007/02/26 22:08:30 simonv Exp $
 */
public class JdbcAclService implements AclService, InitializingBean{
    //~ Static fields/initializers =====================================================================================

    protected static final Log log = LogFactory.getLog(JdbcAclService.class);
    private static String selectAclObjectWithParent = "";
    ...
    /**
     * Instantiates member variables that are depenedent on other injected values
     * of member variables
     */
    public void afterPropertiesSet() {
      selectAclObjectWithParent = "SELECT obj." + lookupStrategy.getObjectIdentifierColumnName() + " obj_id, " 
      + " class.class class "
      + "FROM acl_object_identity obj, acl_object_identity parent, acl_class class "
      + " WHERE obj.parent_object = parent.id AND obj.object_id_class = class.id "
      + " AND parent." + lookupStrategy.getObjectIdentifierColumnName() + " = ? "
