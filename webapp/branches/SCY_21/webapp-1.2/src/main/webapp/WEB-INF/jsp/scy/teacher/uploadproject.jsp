...
<p>Note: If the project is current and is a TELS project, it will show up in the Instant Preview page and the
	Project Library page. Otherwise, it will not show up in either of those pages. This might change at a later time as
	more types of projects are defined in the portal.</p>
