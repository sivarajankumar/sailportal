...
<h2><spring:message code="lostpassword.student.step3" /> </h2>
<h2><spring:message code="lostpassword.student.correct" /> </h2>
<h2><spring:message code="lostpassword.student.enter-new-password" /> </h2>
