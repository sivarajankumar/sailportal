...
<div id="navigationMainProjects">
	<ul>
		<li>
       	...
       	<li>
			<a href="index.html"><input type="image" id="projects" src="<spring:theme code="projects_selected"/>"
    		onmouseover="swapImage('projects','<spring:theme code="projects_selected"/>')" 
    		onmouseout="swapImage('projects','<spring:theme code="projects_selected"/>')"/></a> </li>
    	<li>
