...
public class UserServiceImpl implements UserService {
	...
	public MutableUserDetails createUser(MutableUserDetails userDetails)
		...
		try {
			...
			// create user object with user details in it (no sds at this time)
			// get creation user id from sds
			// add sds user to user object
			// save everything.

			// **hack: first name and last name required by SDS**//
			SdsUserCreateCommandHttpRestImpl command = prepareSDSUserCreateCommand(
	...
	private SdsUserCreateCommandHttpRestImpl prepareSDSUserCreateCommand(
		...
		command.generateRequest(firstName, lastName);
		return command;
	}
