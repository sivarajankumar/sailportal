...
public interface UserDetailsService extends
	...
	/**
	 * Given a unique, non-null username, and any non-null password, creates a MutableUserDetails object.
	 * If username is not unique or username or password is null, throws UserCreationException
	 * 
	 * @param username
	 * @param password
