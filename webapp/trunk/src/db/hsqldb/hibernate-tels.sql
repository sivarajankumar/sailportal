    ...
    alter table acl_entry 
        drop constraint FK5302D47DC9975936;

    alter table acl_entry 
        drop constraint FK5302D47D9A4DE79D;

    alter table acl_object_identity 
        drop constraint FK2A2BB0099B5E7811;

    alter table acl_object_identity 
        drop constraint FK2A2BB009BDC00DA1;

    alter table acl_object_identity 
        drop constraint FK2A2BB0092458F1A3;

    alter table annotationBundles 
        drop constraint FKD986A02F54443B2;

    alter table curnits 
        drop constraint FK4329FBBA1B78E061;

    alter table groups 
        drop constraint FKB63DD9D4E696E7FF;

    alter table groups_related_to_users 
        drop constraint FK3311F7E356CA53B6;

    alter table groups_related_to_users 
        drop constraint FK3311F7E3895EAE0A;

    alter table jnlps 
        drop constraint FK6095FABA532A941;

    alter table offerings 
        drop constraint FK73F0F12DAB4F6201;

    alter table runs 
        drop constraint FK3597481834F8D3;

    alter table runs_related_to_groups 
        drop constraint FK6CD673CD50B193C8;

    alter table runs_related_to_groups 
        drop constraint FK6CD673CD12D98E95;

    alter table runs_related_to_owners 
        drop constraint FK7AC2FE1960AA7F41;

    alter table runs_related_to_owners 
        drop constraint FK7AC2FE1950B193C8;

    alter table sds_offerings 
        drop constraint FK242EBD70A532A941;

    alter table sds_offerings 
        drop constraint FK242EBD701B78E061;

    alter table sds_workgroups 
        drop constraint FK440A0C42AB4F6201;

    alter table sds_workgroups_related_to_sds_users 
        drop constraint FKA31D36785AAC23E7;

    alter table sds_workgroups_related_to_sds_users 
        drop constraint FKA31D3678F342C661;

    alter table student_user_details 
        drop constraint FKC5AA2952D1D25907;

    alter table teacher_user_details 
        drop constraint FKAC84070BD1D25907;

    alter table user_details_related_to_roles 
        drop constraint FKE6A5FBDEE3B038C2;

    alter table user_details_related_to_roles 
        drop constraint FKE6A5FBDE44F8149A;

    alter table users 
        drop constraint FK6A68E08E3B038C2;

    alter table users 
        drop constraint FK6A68E08F342C661;

    alter table wiseworkgroups 
        drop constraint FKF16C83C9F309B437;

    alter table workgroups 
        drop constraint FKEC8E50255AAC23E7;

    alter table workgroups 
        drop constraint FKEC8E502553AE0756;

    alter table workgroups_related_to_users 
        drop constraint FKD724CDB256CA53B6;

    alter table workgroups_related_to_users 
        drop constraint FKD724CDB2F54443B2;
    ...
    drop table annotationBundles if exists;

    drop table curnits if exists;

    drop table granted_authorities if exists;

    drop table groups if exists;

    drop table groups_related_to_users if exists;

    drop table jnlps if exists;

    drop table offerings if exists;

    drop table runs if exists;

    drop table runs_related_to_groups if exists;

    drop table runs_related_to_owners if exists;

    drop table sds_curnits if exists;

    drop table sds_jnlps if exists;

    drop table sds_offerings if exists;

    drop table sds_users if exists;

    drop table sds_workgroups if exists;

    drop table sds_workgroups_related_to_sds_users if exists;

    drop table student_user_details if exists;

    drop table teacher_user_details if exists;

    drop table user_details if exists;

    drop table user_details_related_to_roles if exists;

    drop table users if exists;

    drop table wiseworkgroups if exists;

    drop table workgroups if exists;

    drop table workgroups_related_to_users if exists;
