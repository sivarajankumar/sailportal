    ...
    create table workgroups_relates_to_users (
    ...
    alter table workgroups 
        add constraint FKEC8E5025DF4C7823 
        foreign key (offering_fk) 
        references offerings

    alter table workgroups_relates_to_users 
        add constraint FK27726E8356CA53B6 
        foreign key (user_fk) 
        references users

    alter table workgroups_relates_to_users 
        add constraint FK27726E83DD73EC85 
