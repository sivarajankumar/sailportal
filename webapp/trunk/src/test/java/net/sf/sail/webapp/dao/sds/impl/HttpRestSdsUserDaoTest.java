...
public class HttpRestSdsUserDaoTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    this.sdsUserDao.setSdsUserCreateCommand(this.mockCommand);
  }
  ...
  /**
   * Test method for
   * {@link net.sf.sail.webapp.dao.sds.impl.HttpRestSdsUserDao#retrieveByName(java.lang.String)}.
   */
  public void testRetrieveByName() {
    try {
      this.sdsUserDao.retrieveByName("");
      fail("UnsupportedOperationException expected");
    }
    catch (UnsupportedOperationException expected) {
    }
