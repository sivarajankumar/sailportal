 ...
 * 
 */
public class SdsCurnitCreateCommandHttpRestImplTest extends TestCase {
  ...
  private SdsCurnitCreateCommandHttpRestImpl command;
  ...
  protected void setUp() throws Exception {
    super.setUp();
    this.command = new SdsCurnitCreateCommandHttpRestImpl();
    ...
    this.command.setSdsCurnit(this.expectedSdsCurnit);
  ...
  public void testExecute() throws Exception {
    ...
    SdsCurnit actual = this.command.execute(this.httpRequest);
