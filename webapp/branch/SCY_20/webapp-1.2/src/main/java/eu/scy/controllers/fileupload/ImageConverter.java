...
//	public MediaTracker mediaTracker;        mave
        ...
        */
       public void handleImageConversion(File imageFile) throws IOException,
               FileNotFoundException {
           BufferedImage image = getImage(imageFile);

//		if(imageFileInfo.getCreateIcon()) {
               createIcon(imageFile, image);
//		}
       ...
       private void createIcon(File imageFile, BufferedImage image) throws IOException {
           ...
           File thumbFile = new File(imageFile.getAbsolutePath() + ICON_POSTFIX);
