		...
		<c:forEach var="teacher" items="${teachers}">
			<tr>
				...
				<td><a href="#"
					...
					Password</a></td>
				<td><a href="../j_acegi_switch_user?j_username=${teacher.userDetails.username}">Log in as this user</a>
				</td>
				<td><a href="#"
					   onclick="javascript:popup640('../teacherinfo.html?userName=${teacher.userDetails.username}');">info</a>
				</td>
			</tr>
		</c:forEach>
	</table>
		...
		<c:forEach var="student" items="${students}">
			<tr>
				...
				<td><a href="#"
					...
					Password</a></td>
				<td><a href="../j_acegi_switch_user?j_username=${student.userDetails.username}">Log in as this user</a>
				</td>
				<td><a href="#"
					   onclick="javascript:popup640('../studentinfo.html?userName=${student.userDetails.username}');">info</a>
				</td>
			</tr>
		</c:forEach>
	</table>
		...
		<c:forEach var="admin" items="${admins}">
			<tr>
				...
				<td><a href="#"
					...
					Password</a></td>
				<td><a href="../j_acegi_switch_user?j_username=${admin.userDetails.username}">Log in as this user</a>
				</td>
			</tr>
		</c:forEach>
	</table>
		...
		<c:forEach var="user" items="${other}">
			<tr>
				...
				<td><a href="#"
					...
					Password</a></td>
				<td><a href="../j_acegi_switch_user?j_username=${user.userDetails.username}">Log in as this user</a>
				</td>
			</tr>
		</c:forEach>
	</table>
