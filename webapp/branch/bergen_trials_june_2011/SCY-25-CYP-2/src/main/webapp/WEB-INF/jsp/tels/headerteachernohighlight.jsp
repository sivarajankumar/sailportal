...
<div id="wiseLogo"><a href=".././index.html"
	...
	<img src=".././themes/tels/default/images/WISE-Logo-Medium-1.png"
	alt="WISE Logo" border="0"	id="WISE Medium Logo" /></a></div>
...
<div id="usernameBanner"><sec:authentication
	property="principal.username" /></div>
<div id="signOutBanner"><a href="<c:url value="/j_spring_security_logout"/>"><spring:message code="log.out"/></a></div>
</div>
</div>
