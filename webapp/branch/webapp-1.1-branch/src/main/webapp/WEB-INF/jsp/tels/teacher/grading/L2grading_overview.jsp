...
<div id="navigationL2" class="gradingL2">
	...
	<ul>
		<li >
			<a class="navigationL2_grading_highlight" href="../grading/overview.html"><spring:message code="teacher.grading.l2bar.1"/></a> </li>
       	<li>
       	    <!--  grade-by-step disabled until optimized 
			<a href="../grading/projectPickerGrading.html?gradeByType=step">Grade by Step</a> </li>
			-->
			<a style="color:#999999;" href="#"><spring:message code="teacher.grading.l2bar.2"/></a> </li>
		...
		<li>
			<a href="./projectPickerGrading.html?gradeByType=value"><spring:message code="teacher.grading.l2bar.6"/></a> </li>
		<li>
